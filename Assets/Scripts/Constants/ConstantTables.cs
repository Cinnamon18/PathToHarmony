...
namespace Constants {
	public static class ConstantTables {
		...
		public static double[,] MovementCost = new double[,]
			{ {1, 1, 1.00, 1.5, 0.75, 100, 0.75, 0.75, 0.75, 0.75, 0.75, 1.00, 1.00, 1.00, 04, 04, 04, 04, 04, 04, 1}, //Unarmored
			  {1, 1, 1.00, 1.5, 0.75, 100, 0.75, 0.75, 0.75, 0.75, 0.75, 1.00, 1.00, 1.00, 04, 04, 04, 04, 04, 04, 1}, //Light Infantry
			  {1, 1, 1.00, 2.0, 0.75, 100, 0.75, 0.75, 0.75, 0.75, 0.75, 1.00, 1.00, 1.00, 04, 04, 04, 04, 04, 04, 1}, //Armored Infantry
