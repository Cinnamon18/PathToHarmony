...
namespace AI {
	public class carefulgent : Agent {

		public carefulAgent(Battlefield battlefield, Level level, Action<UnityEngine.Object> Destroy) : base(battlefield, level, Destroy) { }
